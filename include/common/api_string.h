...
TARGET_EXT kchar_t *do_string_n_copy_rev(void *ptr_dst, const void *ptr_src, kuint32_t size);
...
TARGET_EXT kchar_t *kstrncpyr(kchar_t *__dest, const kchar_t *__src, kusize_t __n);
